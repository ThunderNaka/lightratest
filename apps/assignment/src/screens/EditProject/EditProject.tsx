...
import InputsGroup from "../NewProject/InputsGroup";
import TableLinks from "../NewProject/TableLinks";
      ...
      <header className="flex flex-col gap-4">
        <Breadcrumbs
          pages={[
            ...
            { name: "Edit project", href: ROUTES.projects.editProject },
          ]}
        />
        ...
        <div className="flex items-center justify-between">
          ...
          <Button
            size="md"
            className="border-complementary-red-500 bg-white text-complementary-red-500 hover:border-complementary-red-500 hover:bg-white hover:text-complementary-red-500 focus:bg-white focus:ring-white"
          >
            Delete Project
          </Button>
        </div>
